...
export const translations = {
  ...
  'Quality assured softwares firm': 'Qualitätsgesicherte Softwarefirma',
  'MVP Scope': 'MVP-Umfang',
  'Final MVP scope definition. Everything listed here is being built and tested end-to-end as part of the initial deliverable.': 'Finale MVP-Umfangsdefinition. Alles hier Aufgelistete wird als Teil der initialen Lieferung entwickelt und durchgehend (end-to-end) getestet.',
  'User management (login, roles, reset)': 'Benutzerverwaltung (Login, Rollen, Reset)',
  'Hospital, Leasing Company, and Admin portals': 'Krankenhaus-, Leasingfirmen- und Admin-Portale',
  'Nurse Web App (Mobile Optimized) with QR scanning': 'Pflegekräfte-Web-App (mobil optimiert) mit QR-Scanning',
  'Matching engine (specialization, availability, distance, rating)': 'Matching-Engine (Spezialisierung, Verfügbarkeit, Entfernung, Bewertung)',
  'Shift lifecycle with 8 states': 'Schicht-Lebenszyklus mit 8 Status',
  'Web-based QR check-in/out with timestamping': 'Webbasierter QR Check-in/out mit Zeitstempel',
  'Email notifications': 'E-Mail-Benachrichtigungen',
  'Auto-calculated invoicing (PDF)': 'Automatisch berechnete Rechnungsstellung (PDF)',
  'Automated Invoicing & Payment Gateway Integration (Out of scope)': 'Automatisierte Rechnungsstellung & Payment-Gateway-Integration (Nicht im Umfang)',
  'Native iOS/Android Apps (Out of scope)': 'Native iOS/Android-Apps (Nicht im Umfang)',
  'Complex Dunning Engine (Out of scope)': 'Komplexe Mahn-Engine (Nicht im Umfang)',
  'This PRD and all requirements, features, and scope definitions herein are approved as the MVP scope. Any functionality not explicitly defined is considered outside approved scope.': 'Dieses PRD und alle hierin enthaltenen Anforderungen, Funktionen und Umfangsdefinitionen sind als MVP-Umfang genehmigt. Jede Funktionalität, die nicht explizit definiert ist, gilt als außerhalb des genehmigten Umfangs.',
  'None. Final MVP Scope.': 'Keine. Finaler MVP-Umfang.',

  // ─── MVP VISUAL JOURNEY ───────────────────────────────────────────────────
  'COMPREHENSIVE WORKFLOW': 'UMFASSENDER WORKFLOW',
  'The complete lifecycle of a Selma shift': 'Der komplette Lebenszyklus einer Selma-Schicht',
  'From initial admin setup down to exception handling and automated invoicing.': 'Von der anfänglichen Admin-Einrichtung bis hin zur Ausnahmebehandlung und automatisierten Rechnungsstellung.',
  '1. Selma Admin Setup': '1. Selma Admin-Einrichtung',
  'The foundation of the platform starts with compliance and onboarding.': 'Die Grundlage der Plattform beginnt mit Compliance und Onboarding.',
  'Create Hospital Account': 'Krankenhaus-Konto erstellen',
  'Create Leasing Company Account': 'Leasingfirmen-Konto erstellen',
  'Verify Compliance Documents': 'Compliance-Dokumente prüfen',
  'Leasing Company Adds Nurses': 'Leasingfirma fügt Pflegekräfte hinzu',
  'Nurse Completes Profile & Docs': 'Pflegekraft vervollständigt Profil & Dokumente',
  
  '2. Shift Request Flow': '2. Schichtanfrage-Prozess',
  'The hospital specifies the requirements and the matching engine instantly finds the perfect candidates.': 'Das Krankenhaus spezifiziert die Anforderungen und die Matching-Engine findet sofort die perfekten Kandidaten.',
  'Hospital Creates Shift Request (Ward/Date/Time/Spec)': 'Krankenhaus erstellt Schichtanfrage (Station/Datum/Zeit/Spez.)',
  'APPLIED': 'EINGEREICHT',
  'Matching Engine Executes': 'Matching-Engine wird ausgeführt',
  'Filter by:': 'Filtern nach:',
  '• Specialization': '• Spezialisierung',
  '• Availability': '• Verfügbarkeit',
  '• Distance': '• Entfernung',
  '• Rating': '• Bewertung',
  'Top 3 Agencies Selected': 'Top 3 Agenturen ausgewählt',
  'Email Notification Sent': 'E-Mail-Benachrichtigung gesendet',
  
  '3. Leasing Company Flow': '3. Leasingfirmen-Prozess',
  'Agencies review incoming requests and assign available nurses.': 'Agenturen prüfen eingehende Anfragen und weisen verfügbare Pflegekräfte zu.',
  'Agency Reviews Request': 'Agentur prüft Anfrage',
  'ACCEPT': 'AKZEPTIEREN',
  'REJECT': 'ABLEHNEN',
  'Shift': 'Schicht',
  'ACCEPTED': 'AKZEPTIERT',
  'Assign Nurse': 'Pflegekraft zuweisen',
  'ASSIGNED': 'ZUGEWIESEN',
  'Next Agency Invited': 'Nächste Agentur eingeladen',
  
  '4. Nurse Flow': '4. Pflegekräfte-Prozess',
  'Nurses receive, confirm, and receive automated secure access for the shift.': 'Pflegekräfte empfangen, bestätigen und erhalten automatisierten, sicheren Zugang für die Schicht.',
  'Nurse Receives Assignment': 'Pflegekraft erhält Zuweisung',
  'CONFIRMED': 'BESTÄTIGT',
  'QR Code Generated': 'QR-Code generiert',
  'QR Sent By Email': 'QR per E-Mail gesendet',
  '24 Hour Reminder': '24-Stunden-Erinnerung',
  'Return To Agency': 'Zurück an Agentur',
  
  '5. Shift Execution Flow': '5. Schichtausführungs-Prozess',
  'Real-time attendance tracking via QR scans at the hospital ward.': 'Echtzeit-Anwesenheitserfassung per QR-Scan auf der Krankenhausstation.',
  'Nurse Arrives At Hospital': 'Pflegekraft kommt im Krankenhaus an',
  'QR Scan (Check-In)': 'QR-Scan (Check-In)',
  'Timestamp Recorded': 'Zeitstempel erfasst',
  'IN PROGRESS': 'IN BEARBEITUNG',
  'Shift Worked': 'Schicht gearbeitet',
  'QR Scan (Check-Out)': 'QR-Scan (Check-Out)',
  'Hours Calculated': 'Stunden berechnet',
  'COMPLETED': 'ABGESCHLOSSEN',
  
  '6. Invoice Generation Flow': '6. Rechnungserstellungs-Prozess',
  'Instant financial settlement based on the exact tracked time.': 'Sofortige finanzielle Abrechnung basierend auf der exakt erfassten Zeit.',
  'Calculate Worked Hours': 'Geleistete Stunden berechnen',
  'Hours × Hourly Rate': 'Stunden × Stundensatz',
  'Calculate Selma Commission': 'Selma-Provision berechnen',
  'Generate Hospital Invoice (Gross Amount)': 'Krankenhaus-Rechnung erstellen (Bruttobetrag)',
  'Generate Agency Invoice (Net Amount After Commission)': 'Agentur-Rechnung erstellen (Nettobetrag nach Provision)',
  'PDF Generated': 'PDF generiert',
  'Download Available (Hospital / Agency / Admin)': 'Download verfügbar (Krankenhaus / Agentur / Admin)',
  
  '7. Admin Exception Flow': '7. Admin-Ausnahmeprozess',
  'Failsafe mechanisms for manual corrections and robust auditing.': 'Ausfallsichere Mechanismen für manuelle Korrekturen und robuste Prüfung.',
  'Failed QR Scan': 'Fehlgeschlagener QR-Scan',
  'Attendance Flagged': 'Anwesenheit markiert',
  'Admin Review': 'Admin-Überprüfung',
  'Manual Correction': 'Manuelle Korrektur',
  'Audit Log Created': 'Audit-Protokoll erstellt',
  'Invoice Released': 'Rechnung freigegeben',
